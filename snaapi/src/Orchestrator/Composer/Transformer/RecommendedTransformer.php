...
/**
 * Transforms recommended editorial aggregates into API response format.
 *
 * This transformer follows the Single Responsibility Principle (SRP)
 * by focusing solely on recommended editorial transformation.
 *
 * @author SNAAPI Refactoring Team
 */
final readonly class RecommendedTransformer implements RecommendedTransformerInterface
{
    ...
    public function transform(array $recommended, string $siteId): array
    {
        ...
        foreach ($recommended as $aggregate) {
            ...
            $transformed[] = [
                ...
                'editorial' => $this->generateEditorialUrl($editorial, $aggregate->section, $siteId),
