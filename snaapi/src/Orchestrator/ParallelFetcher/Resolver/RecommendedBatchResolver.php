...
/**
 * Special batch resolver for recommended editorials with dependencies.
 *
 * This resolver fetches not only the recommended editorial itself but also
 * all its dependencies (section, journalists, multimedia) in parallel,
 * returning complete EditorialAggregate objects ready for transformation.
 *
 * Follows the same pattern as InsertedNewsBatchResolver but is kept separate
 * for clarity and potential future divergence in business logic.
 */
final readonly class RecommendedBatchResolver implements BatchResolverInterface
{
    ...
    /**
     * Resolves multiple recommended editorials with their dependencies.
     *
    ...
    /**
     * Resolves a single recommended editorial with all its dependencies.
     *
    ...
    {
        // Wait for all promises and build aggregate
